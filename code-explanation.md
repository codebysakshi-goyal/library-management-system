...
**Purpose:** Handles student registration, user login, and returning details of the currently logged-in user.
...
**Purpose:** Implements book-related operations such as listing, searching, adding, updating, and deleting books.
...
**Path:** `backend/controllers/issueController.js`

**Purpose:** Manages issue, return, dashboard summary, and issued-book record operations.
...
**Purpose:** Handles student list, student details, profile update, and student deletion functions.
...
**Purpose:** Contains the SQL statements used to create the main database tables and constraints.
...
**Purpose:** Contains initial seed data used during first-time database setup.
...
**Purpose:** Verifies JWT tokens and protects private routes by attaching the authenticated user to the request.
...
**Purpose:** Restricts route access based on user role such as admin or student.
...
**Purpose:** Defines authentication-related API endpoints and connects them with controller methods.
...
**Path:** `backend/routes/bookRoutes.js`

**Purpose:** Defines book-related API endpoints for admin and student access.
...
**Path:** `backend/routes/issueRoutes.js`

**Purpose:** Defines issue and return related API endpoints and dashboard summary routes.
...
**Purpose:** Defines student and profile related API endpoints.
...
**Purpose:** Generates JWT tokens after successful authentication.
...
**Path:** `frontend/add-book.html`

**Purpose:** Form page used by the admin to add a new book.
...
**Path:** `frontend/admin-books.html`

**Purpose:** Admin page for viewing and managing all books.
...
**Purpose:** Admin dashboard page showing library summary information.
...
**Purpose:** College logo image asset used in the frontend interface.

**Code:**

> This file is a binary image asset, so code content is not displayed in Markdown.

### frontend/book-details.html

**Path:** `frontend/book-details.html`

**Purpose:** Displays detailed information of a selected book.
...
**Purpose:** Styles authentication-related pages such as login and registration.
...
### frontend/css/books.css

**Path:** `frontend/css/books.css`

**Purpose:** Styles book listing and book management pages.
...
**Purpose:** Styles admin and student dashboard pages.
...
**Path:** `frontend/css/form.css`

**Purpose:** Styles forms used in book management, profile update, and other input pages.
...
### frontend/css/issue.css

**Path:** `frontend/css/issue.css`

**Purpose:** Styles issue and issue-record related pages.
...
**Path:** `frontend/css/profile.css`

**Purpose:** Styles the profile page.
...
**Purpose:** Contains common global styles used across the frontend.
...
**Path:** `frontend/css/table.css`

**Purpose:** Styles tables used in different pages.
...
### frontend/edit-book.html

**Path:** `frontend/edit-book.html`

**Purpose:** Form page used by the admin to edit an existing book.
...
**Purpose:** Home page of the project that introduces the system and provides navigation links.
...
### frontend/issue-book.html

**Path:** `frontend/issue-book.html`

**Purpose:** Admin page used to issue a book to a student.
...
### frontend/issued-records.html

**Path:** `frontend/issued-records.html`

**Purpose:** Displays all issue and return records for the admin.
...
**Path:** `frontend/js/add-book.js`

**Purpose:** Handles frontend logic for adding a new book.
...
### frontend/js/admin-books.js

**Path:** `frontend/js/admin-books.js`

**Purpose:** Handles book listing, search, filter, and delete actions on the admin books page.
...
**Path:** `frontend/js/admin-dashboard.js`

**Purpose:** Handles admin dashboard summary data rendering.
...
**Purpose:** Contains common API request and local storage helper functions.
...
**Purpose:** Handles login and registration form submission on the frontend.
...
**Path:** `frontend/js/book-details.js`

**Purpose:** Loads and displays a selected book on the details page.
...
**Path:** `frontend/js/common.js`

**Purpose:** Contains shared frontend utilities such as navbar rendering, footer rendering, date formatting, and authentication checks.
...
### frontend/js/edit-book.js

**Path:** `frontend/js/edit-book.js`

**Purpose:** Handles frontend logic for editing a selected book.
...
### frontend/js/issue-book.js

**Path:** `frontend/js/issue-book.js`

**Purpose:** Handles frontend issue-book form logic.
...
### frontend/js/issued-records.js

**Path:** `frontend/js/issued-records.js`

**Purpose:** Loads and manages issue records on the admin side.
...
### frontend/js/my-issued-books.js

**Path:** `frontend/js/my-issued-books.js`

**Purpose:** Loads issued-book records for the logged-in student.
...
**Purpose:** Handles profile display and update operations on the frontend.
...
### frontend/js/student-books.js

**Path:** `frontend/js/student-books.js`

**Purpose:** Handles book listing and search for student users.
...
**Path:** `frontend/js/student-dashboard.js`

**Purpose:** Loads dashboard content for students.
...
**Path:** `frontend/js/student-details.js`

**Purpose:** Loads and displays selected student details for the admin.
...
**Path:** `frontend/js/students.js`

**Purpose:** Loads and manages student records on the admin side.
...
**Purpose:** Login page for admin and student users.
...
### frontend/my-issued-books.html

**Path:** `frontend/my-issued-books.html`

**Purpose:** Shows the books currently or previously issued to the logged-in student.
...
**Path:** `frontend/not-found.html`

**Purpose:** Error page shown when a page or route is not found.
...
**Purpose:** Profile page for viewing and updating user information.
...
### frontend/student-books.html

**Path:** `frontend/student-books.html`

**Purpose:** Displays book listing for student users.
...
**Path:** `frontend/student-dashboard.html`

**Purpose:** Student dashboard page for student-specific actions and overview.
...
**Path:** `frontend/student-details.html`

**Purpose:** Displays complete details of a selected student and related issue records.
...
**Path:** `frontend/students.html`

**Purpose:** Displays the student list for admin management.
...
### frontend/unauthorized.html

**Path:** `frontend/unauthorized.html`

**Purpose:** Error page shown when a user tries to access a restricted page.
